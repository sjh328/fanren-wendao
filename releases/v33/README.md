...
当前版本 **v31「登仙」**（六路深审后的全方位大升级：十四处 P0——个人线灵石加成口径倒挂·宗门特殊兑换死按钮·教程剧情叠开·印记重刷·灵兽助战异常·精英基线死代码·塔层奖额度不重置·破绽不衰减·格挡死键·器魂重铸后缀失效等 / 四十八条真 bug 批修 / **仙界四阶循环**——地仙→天仙→金仙→大罗，仙元晋层、阶满仙劫、大罗证道祖之境 / 战斗纵深——合击付费充能·控制递减·塔规则祝福·AI 针对性应对·连祭炼×5·器胚残片保底 / 灵兽江湖——亲昵三技·寻宝归来三选一·前世残忆变奏·来世预约 / 工程修缮——无障碍·存档管理·成就扩容至 62 项，详见 `UPDATE_NOTES.md`；
...
npm run test:all    # 十六套脚本全量回归（先自动 build，断言随版本增长）
...
index.html   唯一入口（引用 game.js?v=47，改版时递增 N 清缓存）
