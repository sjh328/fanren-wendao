...
当前版本 **v26「拨云」**（不加新玩法，全面打磨：移动端 App-Shell 重构——顶栏/横幅/底栏常驻·
单一滚动源·战斗操作全程一屏可见 / 「提醒」卡朱砂实底修复不可读·进度条文字重墨晕影 /
任务引导升级——行动横幅带目标进度与目的地·「前往」直达鎏金闪光 / 十六处 bug 修复 /
炼丹火候入口与丹药品质激活——详见 `UPDATE_NOTES_V26.md`）。
