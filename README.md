...
当前版本 **v38「大衍」**（深度扩版：**十大新系统**——道途双脉 12 亚流派/自创功法悟法/元神化身/灵兽繁育/天劫三段劫势/洞府阵法夜袭/天道誓言/秘境异变/读招洞察+战意爆发/仙庭九品体系；**数值贴片特点化**——宗门五家招牌/套装技四套齐备/12 称号/传承遗风/道韵协奏/物种招牌/季议代行；摩擦去除——碾压秒胜/塔内连战/行权扩容，总时长不变，详见 `UPDATE_NOTES.md`；
v37「清源」经济封堵见 `docs/update-notes/UPDATE_NOTES_V37.md`，更早版本归档在同目录。
...
index.html   唯一入口（引用 game.js?v=54；缓存号口径 = 16 + 版本号，v37 发布时递增至 53 清缓存）
