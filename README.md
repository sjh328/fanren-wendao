...
当前版本 **v27「归一」**（不加新玩法，把系统织成网：声望经济闭环——悬赏赏格真实入账·践诺积誉·红尘相助 /
洞府死代码激活——炼丹房提成丹率·演武场加攻防 / 离线日更照常结算——灵泉·访客·节庆 / 界面大升级——
顶栏三组式·问道支线四组归位·江湖交情量表 / 移动端再优化——触控 ≥40px·键盘让位·横屏适配·
刘海避让修复·字号缩放真实生效 / 二十二处 bug 修复——详见 `UPDATE_NOTES_V27.md`）。
