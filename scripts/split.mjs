...
const MAP = [
  ...
  ['js/systems/status-fx.js', ['StatusFx']],
  ['js/systems/explore.js', ['buildMonster', 'Explore', 'EventSys']],
  ...
  ['js/systems/festival.js', ['FestivalSys', 'window.FestivalSys']],
  ['js/systems/npc.js', ['NpcSys', 'PersonalSys', 'window.PersonalSys']],
  ['js/systems/dungeon.js', ['DungeonSys']],
  ['js/systems/tower.js', ['TowerSys', 'window.TowerSys']],
