...
try {
  ...
  s2.total >= 77 && s2.pl === 72 ? pass(`S2 剧情脚本 ${s2.total} 段（主线 39 + 个人线 72·v30 补六位 + 终章暗线），共 ${s2.scenes} 场`) : fail('S2 脚本库', JSON.stringify(s2));
  ...
  s2.mid2 >= 9 && s2.flagScene >= 13 ? pass(`S2 反派暗线插章 mid2 ×${s2.mid2}（v24 补齐九章）+ 旗标分支场景 ${s2.flagScene} 处`) : fail('S2 mid2', JSON.stringify({ mid2: s2.mid2, flag: s2.flagScene }));
  ...
  s5.n === 24 && s5.actsOk ? pass('S5 个人线 24 位 NPC × 三幕（v30 补齐全部常驻修士），奖励与永久加成齐备') : fail('S5 个人线数据', JSON.stringify(s5));
