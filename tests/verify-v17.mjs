...
console.log('===== SA 源码静态组 =====');
{
  ...
  sfx.includes('const dataElite = !!d.elite;') && sfx.includes('* foeMul)') && sfx.includes('foeMul = (typeof Game') ? pass('SA12 elitePlus 不叠倍率（A7）；v38（E318）群邪环伺 foeMul 单点') : fail('SA12 倍率', '');
