...
try {
  ...
  s2.total >= 59 && s2.pl === 54 ? pass(`S2 剧情脚本 ${s2.total} 段（主线 36 + 个人线 54·v24 补苏白/林晚照），共 ${s2.scenes} 场`) : fail('S2 脚本库', JSON.stringify(s2));
  ...
  s5.n === 18 && s5.actsOk ? pass('S5 个人线 18 位 NPC × 三幕（v24 补苏白/林晚照），奖励与永久加成齐备') : fail('S5 个人线数据', JSON.stringify(s5));
